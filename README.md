...
### Git messages
Use gitmoji guide when committing.
You can find the emojis meaning on this guide [here](https://gitmoji.carloscuesta.me/).

For your commit messages, follow this syntax :

`[Emoji][Context] > [Action] [File/Package] - [Details]`

* **Context**: Global, Config, UI, Pages, ...
* **Action**: Add, Update, Remove, Clean, ...
* **File/Package**: README, Home, Counter, ...
* **Details**: Any relevant details

*e.g.* `:sparkles: UI > Update Counter - increment two in two`

### Order of components methods
* DisplayName
* PropTypes
* InitialState
* Lifecycle
